...
namespace Company.Function
{
    public class HttpTrigger1
    {
        ...
        using (SqlConnection connection = new SqlConnection("Server=tcp:dawid.database.windows.net,1433;Initial Catalog=cdv-db;Persist Security Info=False;User ID=dawid;Password=duda123!!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"))
        {
            ...
            var people = new List<Person>{
                new Person{FirstName = "Dawid", LastName = "Pasternak", Id = 1}
            };
